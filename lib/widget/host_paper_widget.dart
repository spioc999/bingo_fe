...
class HostPaperWidget extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              _buildHostCard(hostCards[0].id, hostCards[0].columns),
              const SizedBox(height: 80, child: VerticalDivider()),
              _buildHostCard(hostCards[1].id, hostCards[1].columns)
            ],
          ),
          ...
          Row(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _buildHostCard(hostCards[2].id, hostCards[2].columns),
              const SizedBox(height: 80, child: VerticalDivider()),
              _buildHostCard(hostCards[3].id, hostCards[3].columns)
            ],
          ),
          const Padding(padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10), child: Divider(),),
          Row(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _buildHostCard(hostCards[4].id, hostCards[4].columns),
              const SizedBox(height: 80, child: VerticalDivider()),
              _buildHostCard(hostCards[5].id, hostCards[5].columns)
            ],
          ),
        ],
      ),
  ...
  _buildHostCard(int? id, List<ColumnCard>? columns){
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        RomanText('Card $id', fontSize: 10,),
